...
<main>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <img src="./img/piscine_isalo2.jpg" width="600px" height="415px" alt="photo de la piscine naturelle dans le parc d'Isalo ">
            </div>
        </div>
        <div class="row">
            <div class="col-sm">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm">
                <img src="./img/circuit.jpg" width="600px" height="415px" alt="photo de circuit dans le parc d'Isalo">
            </div>
        </div>
    </div>
    <div class="container">
    ...
    <button type="button" class="btn btn-orange btn-lg" data-toggle="button" aria-pressed="false" autocomplete="off">
